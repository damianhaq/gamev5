...
export function lvlUpDiv() {
    ...
    const attackSpeedButton = new NewGui("button", "ulepsz", "", statsUpgrade1div.newElement);
    ...
    function stage2() {
        ...
        if (stats.skills.baseAttack.speed > 101) {
            attackSpeedButton.newElement.disabled = false;
        }
        else {
            attackSpeedButton.newElement.disabled = true;
        }
        if (stats.player.maxXpGrowPrecentage > 10) {
            xpButton.newElement.disabled = false;
        }
        else {
            xpButton.newElement.disabled = true;
        }
    }
}
