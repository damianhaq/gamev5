...
export function pauseDivInitial() {
    ...
    const mfl = new NewGui("h3", stats.skills.magicField.name, stats.skills.magicField.lvl, magicFieldDiv.newElement);
    const mfd = new NewGui("p", "Damage: ", stats.skills.magicField.damage, magicFieldDiv.newElement);
    const mfas = new NewGui("p", "Attack speed: ", stats.skills.magicField.attackSpeed, magicFieldDiv.newElement);
    const mfr = new NewGui("p", "Range: ", stats.skills.magicField.radius, magicFieldDiv.newElement);
    return [
        add,
        lvl,
        up,
