...
export function goldenSwordUpdate(deltaTime) {
    ...
    if (stats.skills.goldenSword.attackSpeedCounter < 0 &&
        ...
        if (instances.enemiesCh.length > 0 && !game.isPause && instances.player) {
            ...
            instances.projectiles.push(new Projectile(instances.player.x, instances.player.y, stats.skills.goldenSword.radius, stats.skills.goldenSword.movementSpeed, direction, stats.skills.goldenSword.damage, `${stats.skills.goldenSword.counterId}goldenSword`, ["enemyCh"], stats.skills.goldenSword.penetrationNumber, spriteSheetData.weapons.goldenSword));
        }
    }
}
